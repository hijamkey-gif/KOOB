...
MysqlDao::MysqlDao()
{
	const auto& host = (*ConfigMgr::GetInstance())["Mysql"]["Host"];
	const auto& port = (*ConfigMgr::GetInstance())["Mysql"]["Port"];
	const auto& pwd = (*ConfigMgr::GetInstance())["Mysql"]["Passwd"];
	const auto& schema = (*ConfigMgr::GetInstance())["Mysql"]["Schema"];
	const auto& user = (*ConfigMgr::GetInstance())["Mysql"]["User"];
