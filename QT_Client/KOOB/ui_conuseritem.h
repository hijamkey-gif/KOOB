...
public:
    ...
    void setupUi(QWidget *ConUserItem)
    {
        ...
        ConUserItem->resize(515, 60);
        ConUserItem->setMinimumSize(QSize(0, 60));
        ConUserItem->setMaximumSize(QSize(16777215, 60));
        ...
        widget->setMinimumSize(QSize(55, 55));
        widget->setMaximumSize(QSize(55, 55));
        icon_lb = new QLabel(widget);
        icon_lb->setObjectName("icon_lb");
        icon_lb->setGeometry(QRect(0, 0, 50, 50));
        ...
        user_name_lb->setAlignment(Qt::AlignCenter);
