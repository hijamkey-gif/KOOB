...
public:
    ...
    void setupUi(QWidget *ChatUserWid)
    {
        ...
        ChatUserWid->setMinimumSize(QSize(0, 60));
        ...
        time_wid->setMinimumSize(QSize(60, 60));
        time_wid->setMaximumSize(QSize(60, 60));
    ...
    void retranslateUi(QWidget *ChatUserWid)
    {
        ...
        user_name_lb->setText(QCoreApplication::translate("ChatUserWid", " TestName", nullptr));
        user_chat_lb->setText(QCoreApplication::translate("ChatUserWid", " : Hellow world!", nullptr));
        time_lb->setText(QCoreApplication::translate("ChatUserWid", "15:11", nullptr));
    } // retranslateUi
