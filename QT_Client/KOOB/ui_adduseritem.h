...
public:
    ...
    void setupUi(QWidget *AddUserItem)
    {
        ...
        AddUserItem->resize(296, 70);
        AddUserItem->setMinimumSize(QSize(0, 70));
        AddUserItem->setMaximumSize(QSize(10000, 70));
        horizontalLayout = new QHBoxLayout(AddUserItem);
        horizontalLayout->setObjectName("horizontalLayout");
        add_tip = new QLabel(AddUserItem);
        add_tip->setObjectName("add_tip");
        add_tip->setMinimumSize(QSize(20, 20));
        add_tip->setMaximumSize(QSize(20, 20));
        ...
        right_tip->setMinimumSize(QSize(20, 20));
        right_tip->setMaximumSize(QSize(20, 20));
    ...
    void retranslateUi(QWidget *AddUserItem)
    {
        ...
        message_tip->setText(QCoreApplication::translate("AddUserItem", "\346\237\245\346\211\276\357\274\232uid/name", nullptr));
