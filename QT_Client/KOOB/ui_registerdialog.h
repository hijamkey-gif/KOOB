...
public:
    ...
    void setupUi(QDialog *RegisterDialog)
    {
        ...
        RegisterDialog->resize(800, 500);
        RegisterDialog->setMaximumSize(QSize(800, 500));
        ...
        pass_visible = new ClickedLabel(widget_4);
        ...
        horizontalLayout_5->setContentsMargins(0, -1, 5, 0);
        ...
        get_code->setMinimumSize(QSize(0, 23));
        get_code->setMaximumSize(QSize(16777215, 23));
